...
export default function Support() {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#070913] text-gray-100 p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 w-full mt-6 mb-8">
        ...
        <div className="flex flex-col justify-between p-5 bg-[#0B0F19]/60 border border-slate-800/80 rounded-xl hover:border-slate-700/60 transition-all w-full min-h-[140px] text-left">
          ...
          <div className="mt-4 flex items-center space-x-2 bg-emerald-950/20 border border-emerald-500/20 px-2.5 py-1 rounded-md w-fit">
      ...
      {/* 📐 3. TWO-COLUMN HIGH-DENSITY GRIDLAYOUT */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-6">
        
        {/* 🎫 LEFT COLUMN: Enterprise Incident Management */}
        <div className="lg:col-span-7 flex flex-col space-y-6">
          ...
          {/* Ticket Ledger Grid */}
          <div className="bg-[#0B0F19]/60 backdrop-blur border border-slate-800 rounded-xl p-6 shadow-xl">
            <h3 className="text-sm font-semibold text-white mb-4">Enterprise Incident Ledger</h3>
        ...
        {/* 🤖 RIGHT COLUMN: Dedicated DevOps AI Assistant & Technical Docs */}
        <div className="lg:col-span-5 flex flex-col space-y-6">
          
          {/* AI Support Agent Terminal */}
          <div className="bg-[#0B0F19]/90 border border-slate-800 rounded-xl overflow-hidden shadow-2xl flex flex-col h-[400px]">
            {/* Terminal Titlebar */}
            ...
            {/* Terminal Feed */}
            <div className="flex-1 p-4 overflow-y-auto font-mono text-xs space-y-3 bg-[#05070f] scrollbar-thin scrollbar-thumb-slate-800">
            ...
            {/* Terminal Input */}
            <form onSubmit={handleSendMessage} className="bg-slate-950 p-2.5 border-t border-slate-800/80 flex items-center gap-2">
              <input
                type="text"
                value={inputMessage}
              ...
              <button
                type="submit"
                className="p-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded transition-colors active:scale-95 cursor-pointer"
              >
                <Send size={13} />
              </button>
            </form>
          ...
          {/* Technical FAQ Accordion Grid */}
          <div className="bg-[#0B0F19]/60 backdrop-blur border border-slate-800 rounded-xl p-6 shadow-xl space-y-3">
            <h3 className="text-sm font-semibold text-white mb-2">Technical FAQ Accordion</h3>
            {faqs.map((faq, idx) => {
              const isOpen = openFaq === idx;
              return (
                <div key={idx} className="border border-slate-800 rounded-lg overflow-hidden bg-[#111624]/40">
                  <button
                    type="button"
                  ...
                  {isOpen && (
                    <div className="p-3.5 pt-0 border-t border-slate-800/40 text-xs text-slate-400 font-mono leading-relaxed bg-[#0d101a]/30">
                      {faq.a}
                    </div>
                  )}
                </div>
