...
const Admin = () => {
  // Active State Data for Tenant Registries
  const [tenants, setTenants] = useState([
    { id: 'usr_892b4x', namespace: 'tenant_cluster_892b4x', tier: 'Enterprise', dataSize: '124.5 GB' },
    { id: 'usr_102v9c', namespace: 'tenant_cluster_102v9c', tier: 'Pro', dataSize: '18.2 GB' },
    { id: 'usr_772m3z', namespace: 'tenant_cluster_772m3z', tier: 'Starter', dataSize: '1.4 GB' },
    { id: 'usr_551k8p', namespace: 'tenant_cluster_551k8p', tier: 'Enterprise', dataSize: '89.1 GB' },
  ]);
            ...
            <table className="table table-xs w-full border-none">
              <thead>
                <tr className="border-b border-gray-800 text-brand-muted font-bold text-left uppercase font-mono text-[10px]">
                  <th className="bg-transparent pl-0 py-3">User ID</th>
              ...
              <tbody>
                {tenants.map((tenant, idx) => (
                  <tr key={idx} className="border-b border-gray-850/30 last:border-none hover:bg-gray-900/10 transition-colors">
                    <td className="bg-transparent pl-0 py-4 font-semibold text-white font-mono">
                      {tenant.id}
                    </td>
                    <td className="bg-transparent py-4 text-brand-primary font-mono">
                      {tenant.namespace}
                    </td>
                    ...
                    <td className="bg-transparent py-4 font-mono text-gray-300">
                      {tenant.dataSize}
                    </td>
                ...
                {tenants.length === 0 && (
                  <tr>
                    <td colSpan="5" className="text-center py-6 text-gray-500 font-mono text-[10px]">No active tenants available in registry.</td>
                  </tr>
                )}
              </tbody>
            </table>
