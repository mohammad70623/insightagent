...
const Analytics = () => {
  ...
  const metrics = useMemo(() => [
    ...
    { title: 'Active Complaints', value: '342', change: '-4.2%', isPositive: false, icon: AlertTriangle },
  ...
  const sentiment = useMemo(() => {
    ...
    return {
      circumference,
      positiveOffset: circumference - (65.2 / 100) * circumference,
      neutralOffset: circumference - ((65.2 + 24.8) / 100) * circumference,
      negativeOffset: circumference - ((65.2 + 24.8 + 10.0) / 100) * circumference,
    };
  }, []);
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4 rounded-xl border border-gray-800/40 bg-surface p-6 shadow-xl flex flex-col justify-between">
          ...
          <div className="space-y-2 pt-4 text-xs font-medium border-t border-gray-850/40">
            <div className="flex justify-between items-center"><span className="flex items-center gap-2"><span className="h-2 w-2 rounded-full bg-brand-primary" /> Positive</span><span className="text-white font-mono">65.2%</span></div>
